...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dustmain.genrelist')),
                ('topbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dustmain.topbooks')),
            ],
        ),
        migrations.CreateModel(
            name='BookItems',
